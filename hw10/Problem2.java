public class Problem2 {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        list[3] = (Animal) (list[0].clone());// creating a clone of the first element and assigning to the 4th
                                             // element
        list[3].setWeight(7.5);// setting the weight to 7.5
        list[4] = (Animal) (list[1].clone()); // creating a clone of the 2nd element and assigning to the 5th
                                              // element
...
// had an error with vs code and running the programs didnt say an error but
// couldnt run to check
